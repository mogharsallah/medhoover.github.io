...
import { Anchor, grommet as defaultGrommet, Grommet, Header, Heading, Box, Main, Avatar, Paragraph, ResponsiveContext, Text } from 'grommet'
...
const grommet = deepMerge(defaultGrommet, {
  global: {
    breakpoints: {
      small: {
        value: 900,
  ...
  return (
    <Grommet theme={grommet}>
      <ResponsiveContext.Consumer>
        {(size) => (
          <>
            <Header size="medium" pad="medium" className="header">
              <Heading level="4">Mohamed Gharsallah</Heading>
              <Box direction="row" textAlign="right" gap="medium">
            ...
            <Main pad={{ horizontal: 'xlarge' }} overflow="none">
              ...
              <Box justify="center" pad={{ top: 'xlarge', bottom: 'large' }} className="page-height">
                <Box animation="slideDown" align="start" justify="center" direction={size !== 'small' ? 'row' : 'column'} gap="large" wrap>
                  ...
                  <Box width={{ max: '500px', min: '350px' }} gap="small">
